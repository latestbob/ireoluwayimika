                ...
                <div className="block md:flex bg-white min-h-[50vh] justify-between mt-10 md:space-x-10">
                    ...
                    <div  className="flex flex-col items-center bg-white  md:flex-row   md:w-1/2">
                        ...
                        <div className="flex flex-col justify-between p-4 leading-normal">
                            ...
                            <p className=" text-center text-sm mb-3 mt-3 md:text-justify font-normal italic text-gray-700 dark:text-gray-400">
                    ...
                    <div  className="flex flex-col items-center bg-white  md:flex-row  md:w-1/2">
                        ...
                        <div className="flex flex-col justify-between p-4 leading-normal">
                            ...
                            <hr className='border-2 w-20 border-amber-500 m-auto md:m-0' />
                            <p className="text-sm text-center md:text-justify mb-3 mt-3 font-normal italic text-gray-700 dark:text-gray-400">
