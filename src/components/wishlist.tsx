...
const WishList = ():JSX.Element => {
    ...
    return (
        <>
              <section id="wish-list" className='bg-white w-full min-h-[80vh] py-16 px-10'>
            <h1 className="text-center text-[#723526] text-2xl md:text-3xl font-bold mt-10">Our Wish List</h1>
