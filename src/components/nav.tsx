            ...
            <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        <Link to="/rsvp" type="button" className="text-white bg-[#723526] hover:bg-[#feebdb] hover:text-[#723526] focus:ring-4 focus:outline-none focus:ring-[#723526] font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            RSVP NOW
                        </Link>
                        <button
                            onClick={toggleMenu}
